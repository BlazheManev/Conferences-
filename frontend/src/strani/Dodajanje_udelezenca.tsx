...
import '../Styles/dodajanje_udelezenca.css';
...
const Dodajanje_udelezenca: React.FC = (props: any) => {
    ...
    return (
        ...
        <Helmet>
            ...
            <Box className="box-sirina box-izgled" sx={{ flexGrow: 1 }}>
                <Grid container className='vsebina_forma_in_seznam' spacing={2}>
                    <Grid item className='vsebina-box' lg={8} xs={12}>
                        <h1>Napiši vabilo na konferenco</h1>
                        <Grid container>
                            ...
                            <Grid item className='textField-emailButton' xs={12}>
                                <Button variant="outlined" className='skrij' onClick={handleClickEmail}>
                                    <FaPlus className='plus-ikona' /> <p> Dodaj</p>
                                </Button>
                            </Grid>
                            ...
                            <Grid item className='textField-zadeva' xs={12}>
                                <Button variant="outlined" className='skrij' onClick={handleClickPosljiEmail}>Pošlji povabilo</Button>
                            </Grid>

                        </Grid>

                    </Grid>
                    <Grid item lg={4} xs={12} className='seznam_emailov'>
                        <h1>Dodani e-maili</h1>
                        <div className='seznam-scrollable' id='scroll_list'>
                            {seznamEmailov.map(item => <Box component="span" className='email-en-element' sx={{ display: 'block' }} key={item}>{item}</Box>)}
                        </div>
                    </Grid>
                </Grid>
            </Box>
...
export default Dodajanje_udelezenca;
