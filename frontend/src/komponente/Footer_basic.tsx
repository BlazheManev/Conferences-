...
const Footer_basic: React.FC = (props: any) => {
                        ...
                        <Grid item xs={12}>
                            <Grid container spacing={1}>
                                ...
                                <Grid item md={4} xs={12}>
                                    ...
                                    <a href="/" className='povezava_footer'>Domov</a>
                                    <br />
                                    <a href="/organizator-prijava" className='povezava_footer'>Organizator</a>
                                    <br />
                                    <a href="/prijava" className='povezava_footer'>Prijava</a>
                                    <br />
                                    <a href="/registracija" className='povezava_footer'>Registracija</a>
                                </Grid>
                                <Grid item md={4} xs={12}>
